        ...
        if(len(landmark_list)!=0):
            ...
            if (my_fingers[1] and not my_fingers[2]):
                ...
                if self.draw_color == (0,0,0):
                    ...
                    cv2.line(self.image_canvas, (self.xp,self.yp),(self.x1,self.y1),color= self.draw_color, thickness=eraser_thickness)

                else:
                    cv2.line(frame, (self.xp,self.yp),(self.x1,self.y1),color= self.draw_color, thickness=brush_thickness)
                    cv2.line(self.image_canvas, (self.xp,self.yp),(self.x1,self.y1),color= self.draw_color, thickness=brush_thickness)
